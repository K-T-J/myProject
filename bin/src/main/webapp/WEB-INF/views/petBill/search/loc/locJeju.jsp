				...
				<div class="bgc">
					...
					<div class="mapdiv" id="region">
						...
						<!-- <g filter="url(#dropshadow)"> -->
							...
							<a id="jeju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=제주특별자치도&siguSel=제주시&pageNum=1&petType=${petType}">
								<title>제주시</title>
                			...
                			<a id="seogwipo" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=제주특별자치도&siguSel=서귀포시&pageNum=1&petType=${petType}">
								<title>서귀포시</title>
