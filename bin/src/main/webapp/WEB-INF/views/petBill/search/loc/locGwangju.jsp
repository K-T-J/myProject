					...
					<div class="mapdiv" id="region">
						...
						<div class="mapdiv" id="region">
							...
							<!-- <g filter="url(#dropshadow)"> -->
								...
								<a id="dongu" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=동구&pageNum=1&petType=${petType}">
									<title>동구</title>
								...
								<a id="seogu" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=서구&pageNum=1&petType=${petType}">
									<title>서구</title>
								...
								<a id="namgu" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=남구&pageNum=1&petType=${petType}">
									<title>남구</title>
								...
								<a id="bukgu" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=북구&pageNum=1&petType=${petType}">
									<title>북구</title>
								...
								<a id="gwangsangu" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=광산구&pageNum=1&petType=${petType}">
									<title>광산구</title>
							...
							<!-- </g> -->
								...
								<text class="TEXT" x="250" y="260">
									<a id="gwangsangu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=광산구&pageNum=1&petType=${petType}">
										광산구
									</a>
								</text>
								<text class="TEXT" x="560" y="160">
									<a id="bukgu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=북구&pageNum=1&petType=${petType}">
										북구
									</a>
								</text>
								<text class="TEXT" x="440" y="330">
									<a id="seogu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=서구&pageNum=1&petType=${petType}">
										서구
									</a>
								</text>
								<text class="TEXT" x="480" y="430">
									<a id="namgu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=남구&pageNum=1&petType=${petType}">
										남구
									</a>
								</text>
								<text class="TEXT" x="650" y="390">
									<a id="dongu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=광주광역시&siguSel=동구&pageNum=1&petType=${petType}">
										동구
									</a>
								</text>
