					...
					<div class="mapdiv" id="region">
						...
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="-60 70 900 870">
							...
							<!-- <g filter="url(#dropshadow)"> -->
								...
								<a id="dongu" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=동구&pageNum=1&petType=${petType}">
									<title>동구</title>
								...
								<a id="jungu" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=중구&pageNum=1&petType=${petType}">
									<title>중구</title>
								...
								<a id="seogu" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=서구&pageNum=1&petType=${petType}">
									<title>서구</title>
								...
								<a id="yuseong" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=유성구&pageNum=1&petType=${petType}">
									<title>유성구</title>
								...
								<a id="daedeok" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=대덕구&pageNum=1&petType=${petType}">
									<title>대덕구</title>
							...
							<text id="dongu" class="TEXT" x="552" y="551">
								<a id="dongu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=동구&pageNum=1&petType=${petType}">
									동구
								</a>
							</text>
							<text id="jungu" class="TEXT" x="414" y="666">
								<a id="jungu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=중구&pageNum=1&petType=${petType}">
									중구
								</a>
							</text>
							<text id="LCD30170" class="TEXT" x="272" y="667">
								<a id="seogu" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=서구&pageNum=1&petType=${petType}">
									서구
								</a>
							</text>
							<text id="LCD30200" class="TEXT" x="247" y="410">
								<a id="yuseong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=유성구&pageNum=1&petType=${petType}">
									유성구
								</a>
							</text>
							<text id="daedeok" class="TEXT" x="477" y="317">
								<a id="daedeok" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대전광역시&siguSel=대덕구&pageNum=1&petType=${petType}">
									대덕구
								</a>
							</text>
						</svg>
