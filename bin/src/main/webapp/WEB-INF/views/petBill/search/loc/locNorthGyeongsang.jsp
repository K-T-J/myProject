						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
		                        ...
		                        <c:if test="${sessionScope.kakaoId != null ||sessionScope.userId != null && sessionScope.userId ne 'admin'}">
		                        	<li class="nav-item active"><a class="nav-link" href="/petBill/user/logoutPrt">로그아웃</a></li>
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="/petBill/search/loc/locNorthGyeongsang?petType=${'dog'}&diagnosis=${'dAllTest'}">강아지</a>
                                    	<a class="dropdown-item" href="/petBill/search/loc/locNorthGyeongsang?petType=${'cat'}&diagnosis=${'cAllTest'}">고양이</a>
									</div>
								</li>
							</ul>
							...
							<g transform="translate(-309.61112,-642.37589)">
						  	...
						  	<defs>
							    ...
							    <filter id="dropshadow2">
							  	...
							  	<a id="mungyeong" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=문경시&pageNum=1&petType=${param.petType}">
								  	<title>문경시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="sangju" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=상주시&pageNum=1&petType=${param.petType}">
								  	<title>상주시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="yecheon" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=예천군&pageNum=1&petType=${param.petType}">
							  		<title>예천군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="yeongju" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영주시&pageNum=1&petType=${param.petType}">
								  	<title>영주시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="bonghwa" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=봉화군&pageNum=1&petType=${param.petType}">
							  		<title>봉화군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="yeongyang" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영양군&pageNum=1&petType=${param.petType}">
								  	<title>영양군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="uljin" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=울진군&pageNum=1&petType=${param.petType}">
								  	<title>울진군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="andong" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=안동시&pageNum=1&petType=${param.petType}">
								  	<title>안동시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="uiseong" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=의성군&pageNum=1&petType=${param.petType}">
								  	<title>의성군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="gimcheon" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=김천시&pageNum=1&petType=${param.petType}">
								  	<title>김천시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="gimchgumieon" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=구미시&pageNum=1&petType=${param.petType}">
								  	<title>구미시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="seongju" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=성주군&pageNum=1&petType=${param.petType}">
							  		<title>성주군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="goryeong" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=고령군&pageNum=1&petType=${param.petType}">
								  	<title>고령군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="chilgok" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=칠곡군&pageNum=1&petType=${param.petType}">
								  	<title>칠곡군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="gunwi" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=군위군&pageNum=1&petType=${param.petType}">
								  	<title>군위군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="yeongdeok" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영덕군&pageNum=1&petType=${param.petType}">
								  	<title>영덕군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="yeongdeok" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=청송군&pageNum=1&petType=${param.petType}">
								  	<title>청송군</title>
								    <path class="OUTLINE"
							    ...
							    <a id="pohang" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=포항시&pageNum=1&petType=${param.petType}">
								  	<title>포항시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="yeongcheon" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영천시&pageNum=1&petType=${param.petType}">
								  	<title>영천시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="gyeongsan" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=경산시&pageNum=1&petType=${param.petType}">
								  	<title>경산시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="cheongdo" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=청도군&pageNum=1&petType=${param.petType}">
								  	<title>청도군</title>
								    <path
							    ...
							    <a id="gyeongju" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=경주시&pageNum=1&petType=${param.petType}">
								  	<title>경주시</title>
								    <path class="OUTLINE"
							    ...
							    <a id="ulleungdo" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=울릉군&pageNum=1&petType=${param.petType}">
								  	<title>울릉도</title>
								    <path class="OUTLINE"
							    ...
							    <text class="TEXT" x="525" y="825" id="pohang" >
							    	<a id="pohang" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=포항시&pageNum=1&petType=${param.petType}">
							    		포항시
							    	</a>	
							    </text>
							    <text class="TEXT" x="390"  y="815" id="gumi" >
							    	<a id="gumi" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=구미시&pageNum=1&petType=${param.petType}">
							    		구미시
									</a>
								</text>
							    <text class="TEXT" x="460" y="890" id="gyeongsan" >
							    	<a id="gyeongsan" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=경산시&pageNum=1&petType=${param.petType}">
							    		경산시
							    	</a>	
							    </text>
							    <text class="TEXT" x="520" y="885" id="gyeongju" >
							    	<a id="gyeongju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=경주시&pageNum=1&petType=${param.petType}">
							    		경주시
							    	</a>	
							    </text>
							    <text class="TEXT" x="450" y="750" id="andong" >
							    	<a id="andong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=안동시&pageNum=1&petType=${param.petType}">
							    		안동시
							    	</a>	
							    </text>
							    <text class="TEXT" x="352" y="843" id="gimcheon" >
							    	<a id="gimcheon" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=김천시&pageNum=1&petType=${param.petType}">
							    		김천시
							    	</a>	
							    </text>
							    <text class="TEXT" x="420" y="700" id="yeongju" >
							    	<a id="yeongju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영주시&pageNum=1&petType=${param.petType}">
							    		영주시
							    	</a>
							    </text>
							    <text class="TEXT" x="350" y="780" id="sangju" >
							    	<a id="sangju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=상주시&pageNum=1&petType=${param.petType}">
							    		상주시
							    	</a>	
							    </text>
							    <text class="TEXT" x="478" y="850" id="yeongcheon" >
							    	<a id="yeongcheon" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영천시&pageNum=1&petType=${param.petType}">
							    		영천시
							    	</a>	
							   	</text>
							    <text class="TEXT" x="365" y="730" id="mungyeong" >
							    	<a id="mungyeong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=문경시&pageNum=1&petType=${param.petType}">
							    		문경시
							    	</a>		
							    </text>
							    <text class="TEXT" x="410" y="853" id="chilgok" >
							    	<a id="chilgok" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=칠곡군&pageNum=1&petType=${param.petType}">
							    		칠곡군
							    	</a>	
							    </text>
							    <text class="TEXT" x="430" y="793" id=""uiseong"" >
							    	<a id="uiseong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=의성군&pageNum=1&petType=${param.petType}">
							    		의성군
							    	</a>	
							    </text>
							    <text class="TEXT" x="525" y="685" id="uljin" >
							    	<a id="uljin" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=울진군&pageNum=1&petType=${param.petType}">
							   			울진군
							   		</a>	
							   	</text>
							    <text class="TEXT" x="405" y="735" id="yecheon" >
							    	<a id="yecheon" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=예천군&pageNum=1&petType=${param.petType}">
							    		예천군
									</a>
								</text>
							    <text class="TEXT" x="455" y="917" id="cheongdo" >
							    	<a id="cheongdo" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=청도군&pageNum=1&petType=${param.petType}">
							    		청도군
							    	</a>	
							    </text>
							    <text class="TEXT" x="375" y="873" id="seongju" >
							       	<a id="seongju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=성주군&pageNum=1&petType=${param.petType}">
							       		성주군
							    	</a>
							    </text>
							    <text class="TEXT" x="530" y="770" id="yeongdeok" >
							    	<a id="yeongdeok" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영덕군&pageNum=1&petType=${param.petType}">
							    		영덕군
							    	</a>	
							    </text>
							    <text class="TEXT" x="383" y="905" id="goryeong" >
							    	<a id="goryeong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=고령군&pageNum=1&petType=${param.petType}">
							    		고령군
							    	</a>	
							    </text>
							    <text class="TEXT" x="467" y="685" id="bonghwa" >
							    	<a id="bonghwa" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=봉화군&pageNum=1&petType=${param.petType}">
							    		봉화군
							    	</a>	
							    </text>
							    <text class="TEXT" x="497" y="790" id="cheongsong" >
							    	<a id="cheongsong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=청송군&pageNum=1&petType=${param.petType}">
							    		청송군
							    	</a>	
							    </text>
							    <text class="TEXT" x="440" y="830" id="gunwi" >
							    	<a id="gunwi" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=군위군&pageNum=1&petType=${param.petType}">
							    		군위군
							    	</a>
							    </text>
							    <text class="TEXT" x="503" y="730" id="yeongyang" >
							    	<a id="yeongyang" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=영양군&pageNum=1&petType=${param.petType}">
							    		영양군
							    	</a>	
							    </text>
							    <text class="TEXT" x="580" y="820" id="text3097" >
							    	<a id="ulleungdo" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=경상북도&siguSel=울릉군&pageNum=1&petType=${param.petType}">
							    		울릉도/독도
							    	</a>	
							    </text>
							</g>
