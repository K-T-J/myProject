			...
			<div class="border-end bg-white" id="sidebar-wrapper">
				...
				<div class="sidebar-heading border-bottom bg-light">
					<a href="/petBill/user/main">
						<img src="/resources/img/petBill/로고화면.png" style="width: 190px; w margin-top: 10px;">
					</a>
				</div>
							...
							<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="/petBill/search/loc/locUlsan?petType=${'dog'}&diagnosis=${'dAllTest'}">강아지</a>
                                    	<a class="dropdown-item" href="/petBill/search/loc/locUlsan?petType=${'cat'}&diagnosis=${'cAllTest'}">고양이</a>
									</div>
								</li>
							</ul>
					...
					<div class="mapdiv" id="region">
						...
						<defs>
							...
							<!-- <g filter="url(#dropshadow)"> -->
								...
								<a id="jung" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=중구&pageNum=1&petType=${param.petType}">
									<title>중구</title>
								...
								<a id="nam" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=남구&pageNum=1&petType=${param.petType}">
									<title>남구</title>
								...
								<a id="dong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=동구&pageNum=1&petType=${param.petType}">
									<title>동구</title>
								...
								<a id="buk" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=북구&pageNum=1&petType=${param.petType}">
									<title>북구</title>
								...
								<a id="ulju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=울주군&pageNum=1&petType=${param.petType}">
									<title>울주군</title>
