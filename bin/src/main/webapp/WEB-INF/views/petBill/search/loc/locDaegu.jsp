							...
							<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="/petBill/search/loc/locDaegu?petType=${'dog'}&diagnosis=${'dAllTest'}">강아지</a>
                                    	<a class="dropdown-item" href="/petBill/search/loc/locDaegu?petType=${'cat'}&diagnosis=${'cAllTest'}">고양이</a>
									</div>
								</li>
							</ul>
					...
					<div class="mapdiv" id="region">
						...
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="-30 70 950 890">
							...
							<!-- <g filter="url(#dropshadow)"> -->
								...
								<a id="jungu" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=중구&pageNum=1&petType=${param.petType}">
									<title>중구</title>
									<path id="jungu" class="OUTLINE" d="M 476 366 l 14 5 -2 18 -4 18 -12 -3 -14 -3 -16 1 -7 -3 -9 -7 7 -21 -1 -8 3 1 0 -6 20 3 13 2 z " />
								</a>
								<a id="dongu" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=동구&pageNum=1&petType=${param.petType}">
									<title>동구</title>
								...
								<a id="seogu" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=서구&pageNum=1&petType=${param.petType}">
									<title>서구</title>
								...
								<a id="namgu" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=남구&pageNum=1&petType=${param.petType}">
									<title>남구</title>
								...
								<a id="bukgu" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=북구&pageNum=1&petType=${param.petType}">
									<title>북구</title>
								...
								<a id="suseongu" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=수성구&pageNum=1&petType=${param.petType}">
									<title>수성구</title>
								...
								<a id="dalseogu" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=달서구&pageNum=1&petType=${param.petType}">
									<title>달서구</title>
								...
								<a id="dalseongun" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=달성군&pageNum=1&petType=${param.petType}">
									<title>달성군</title>
							...
							<!-- </g> -->
								...
								<text id="LCD27110" class="TEXT" x="459" y="382">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=중구&pageNum=1&petType=${param.petType}">
										중구
									</a>
								</text>
								<text id="LCD27140" class="TEXT" x="608" y="243">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=동구&pageNum=1&petType=${param.petType}">
										동구
									</a>	
								</text>
								<text id="LCD27170" class="TEXT" x="387" y="365">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=서구&pageNum=1&petType=${param.petType}">
										서구
									</a>		
								</text>
								<text id="LCD27200" class="TEXT" x="447" y="445">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=남구&pageNum=1&petType=${param.petType}">
										남구
									</a>		
								</text>
								<text id="LCD27230" class="TEXT" x="431" y="256">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=북구&pageNum=1&petType=${param.petType}">
										북구
									</a>	
								</text>
								<text id="LCD27260" class="TEXT" x="571" y="446">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=수성구&pageNum=1&petType=${param.petType}">
										수성구
									</a>	
								</text>
								<text id="LCD27290" class="TEXT" x="355" y="461">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=달서구&pageNum=1&petType=${param.petType}">
										달서구
									</a>	
								</text>
								<text id="LCD27710" class="TEXT" x="270" y="648">
									<a id="dalseongun" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=대구광역시&siguSel=달성군&pageNum=1&petType=${param.petType}">
										달성군
									</a>	
								</text>
