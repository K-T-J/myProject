							...
							<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="/petBill/search/loc/locJeju?petType=${'dog'}&diagnosis=${'dAllTest'}">강아지</a>
                                    	<a class="dropdown-item" href="/petBill/search/loc/locJeju?petType=${'cat'}&diagnosis=${'cAllTest'}">고양이</a>
									</div>
								</li>
							</ul>
				...
				<div class="bgc">
					...
					<div class="mapdiv" id="region">
						...
						<!-- <g filter="url(#dropshadow)"> -->
							...
							<a id="jeju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=제주특별자치도&siguSel=제주시&pageNum=1&petType=${param.petType}">
								<title>제주시</title>
                			...
                			<a id="seogwipo" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=제주특별자치도&siguSel=서귀포시&pageNum=1&petType=${param.petType}">
								<title>서귀포시</title>
