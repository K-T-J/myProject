					...
					<div class="mapdiv" id="region">
						...
						<defs>
							...
							<!-- <g filter="url(#dropshadow)"> -->
								...
								<a id="jung" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=중구&pageNum=1&petType=${petType}">
									<title>중구</title>
								...
								<a id="nam" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=남구&pageNum=1&petType=${petType}">
									<title>남구</title>
								...
								<a id="dong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=동구&pageNum=1&petType=${petType}">
									<title>동구</title>
								...
								<a id="buk" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=북구&pageNum=1&petType=${petType}">
									<title>북구</title>
								...
								<a id="ulju" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=울산광역시&siguSel=울주군&pageNum=1&petType=${petType}">
									<title>울주군</title>
