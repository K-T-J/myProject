							...
							<ul class="navbar-nav ms-auto mt-2 mt-lg-0">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="/petBill/search/loc/locBusan?petType=${'dog'}&diagnosis=${'dAllTest'}">강아지</a>
                                    	<a class="dropdown-item" href="/petBill/search/loc/locBusan?petType=${'cat'}&diagnosis=${'cAllTest'}">고양이</a>
									</div>
								</li>
							</ul>
					...
					<div class="mapdiv" id="region">
						...
						<defs>
							...
							<!-- <g filter="url(#dropshadow)"> -->
								...
								<a id="jung" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=중구&pageNum=1&petType=${param.petType}">
									<title>중구</title>
								...
								<a id="seog" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=서구&pageNum=1&petType=${param.petType}">
									<title>서구</title>
								...
								<a id="dong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=동구&pageNum=1&petType=${param.petType}">
									<title>동구</title>
								...
								<a id="yeongdo" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=영도구&pageNum=1&petType=${param.petType}">
									<title>영도구</title>
								...
								<a id="busanjin" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=부산진구&pageNum=1&petType=${param.petType}">
									<title>부산진구</title>
								...
								<a id="dongrae" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=동래구&pageNum=1&petType=${param.petType}">
									<title>동래구</title>
								...
								<a id="nam" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=남구&pageNum=1&petType=${param.petType}">
									<title>남구</title>
								...
								<a id="nam" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=북구&pageNum=1&petType=${param.petType}">
									<title>북구</title>
								...
								<a id="haeundae" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=해운대구&pageNum=1&petType=${param.petType}">
									<title>해운대구</title>
								...
								<a id="haeundae" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=사하구&pageNum=1&petType=${param.petType}">
									<title>사하구</title>
								...
								<a id="geumjeong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=금정구&pageNum=1&petType=${param.petType}">
									<title>금정구</title>
								...
								<a id="gangseo" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=강서구&pageNum=1&petType=${param.petType}">
									<title>강서구</title>
								...
								<a id="yeonje" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=연제구&pageNum=1&petType=${param.petType}">
									<title>연제구</title>
								...
								<a id="suyeong" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=수영구&pageNum=1&petType=${param.petType}">
									<title>수영구</title>
								...
								<a id="sasang" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=사상구&pageNum=1&petType=${param.petType}">
									<title>사상구</title>
								...
								<a id="gijang" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=기장군&pageNum=1&petType=${param.petType}">
									<title>기장군</title>
							...
							<text class="TEXT" x="630" y="200">
								<a id="gijang" class="OUTLINE" href="/petBill/search/searchResult?sidoSel=부산광역시&siguSel=기장군&pageNum=1&petType=${param.petType}">
									기장군
								</a>
							</text>
